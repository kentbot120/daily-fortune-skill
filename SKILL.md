...
📊 数据基础
八字  <data_anchor_A> → <10字白话：今日能量特征>
星座  <data_anchor_B> → <10字白话：今日星象影响>
紫微  <data_anchor_C> → <10字白话：今日宫位含义>

━━━ 运势速览（★★★★★满分）━━━
💼 事业  ★★★★☆  <15字建议> · <具体依据，引用数据点，10字内>
💰 财运  ★★★☆☆  <15字建议> · <具体依据，引用数据点，10字内>
❤️  人际  ★★★☆☆  <15字建议> · <具体依据，引用数据点，10字内>
💪 健康  ★★☆☆☆  <15字建议> · <具体依据，引用数据点，10字内>
...
```
🔮 2026-03-04 · Kent 的每日运势

【今日主题】能量旺、沟通需稳，适合推进拍板。

📊 数据基础
八字  丙子日·乙木食伤旺·子未有害 → 输出力强，情绪易躁
星座  月亮处女座·水星逆行·木星六分金牛 → 细节敏感，回顾胜推新
紫微  天机命宫·大限初入·流日子女宫 → 思维活跃，利沟通学习

━━━ 运势速览（★★★★★满分）━━━
💼 事业  ★★★★☆  推进创意和策略类任务 · 丙火旺、天机利策划
💰 财运  ★★★☆☆  跟进已有投资，勿新开仓 · 子未相害，避免冲动
❤️  人际  ★★★☆☆  带人做事有优势，语气放软 · 食伤旺易口快伤人
💪 健康  ★★☆☆☆  下午15-19时注意补能量 · 水星逆行耗神经

━━━ 结合今日安排 ━━━
📌 09:35 投资观察：先写「买/不买阈值」再操作，符合今日「先定规则」运势
📌 10:00 英语复习：走输出型练习（口语/写作），天机流日利表达

⚠️ 今日留意：14:00 后避免临时加塞高决策压力事项
✨ 今日一句：规则定好，刀才锋利。
```

**格式约束（输出前逐条核查）：**
- 数据基础：每行必须有 `→ 白话解读`，不得只写术语
- 星级：固定 5 格，用 ☆ 补齐，不得出现 ★★★ 这种不足 5 格的写法
- 每条运势：必须有 `· 数据依据`，依据必须包含具体干支/行星/宫位名称，不得省略或写「综合分析」
- 结合今日安排：必须引用真实 cron 任务名或近期话题，不得写「根据您的日程」等泛泛表述
- 整体字数 ≤400 字
