...
```json
{
  ...
  "career_advice":   "<今日核心建议，约30字，说清楚做什么、怎么做、为什么>",
  "career_good_for": "<适合的工作类型，≤15字，如「创意策划、对外沟通、拍板决策」>",
  "career_avoid":    "<回避的工作类型，≤12字，如「签约、细节审查、被动等待」>",
  "career_reason":   "<引用干支/行星/宫位的依据，≤10字>",

  "wealth_stars":    "<★☆组合，固定5格>",
  "wealth_advice":   "<今日核心建议，约30字，说清楚做什么、怎么做、为什么>",
  "wealth_good_for": "<适合的财务动作，≤15字，如「跟进已有投资、整理账目」>",
  "wealth_avoid":    "<回避的财务动作，≤12字，如「新开仓、冲动消费、大额签约」>",
  "wealth_reason":   "<引用干支/行星/宫位的依据，≤10字>",

  "relationships_stars":    "<★☆组合，固定5格>",
  "relationships_advice":   "<今日核心建议，约30字，说清楚做什么、怎么做、为什么>",
  "relationships_good_for": "<适合处理的人际事项，≤15字>",
  "relationships_avoid":    "<回避的人际行为，≤12字>",
  "relationships_reason":   "<引用干支/行星/宫位的依据，≤10字>",

  "health_stars":    "<★☆组合，固定5格>",
  "health_advice":   "<今日核心建议，约30字，说清楚做什么、怎么做、为什么>",
  "health_good_for": "<适合的运动或恢复方式，≤15字>",
  "health_avoid":    "<回避的行为，≤12字，如「熬夜、高强度决策、空腹剧烈运动」>",
